...
{           
	...
	//def 8208, DAC out
    //DAC2CONL = 0x8308; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN enabled; FLTREN enabled; CBE disabled; IRQM Interrupts are disabled; INSEL CMP2B; DACOEN enabled; 
   //	DAC2CONL = 0x8008; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN enabled; FLTREN disabled; CBE disabled; IRQM Interrupts are disabled; INSEL CMP2B; DACOEN disabled; 
