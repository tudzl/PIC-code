...
{           
	...
	//DAC1CONL = 0x8308; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN enabled; FLTREN enabled; CBE disabled; IRQM Interrupts are disabled; INSEL CMP1B; DACOEN enabled; 
